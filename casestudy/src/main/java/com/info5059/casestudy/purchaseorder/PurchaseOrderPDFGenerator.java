                        ...
                        if (optpo.isPresent()) {
                                ...
                                for (PurchaseOrderLineitem line : purchaseorder.getItems()) {
                                        ...
                                        if (optp.isPresent()) {
                                                ...
                                                cell = new Cell().add(
                                                                new Paragraph(((Integer) product.getQoo()).toString())
                                                                                .setFont(font)
                                                                                .setFontSize(12)
                                                                                .setTextAlignment(
                                                ...
                                                cell = new Cell().add(new Paragraph(formatter
                                                                .format(product.getCostprice().multiply(qty, mc)))
                                                                .setFont(font)
                                                                .setFontSize(12)
                                                                .setTextAlignment(TextAlignment.RIGHT));
                                                table.addCell(cell);
